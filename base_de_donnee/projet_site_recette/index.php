            ...
            <nav>
                <ul id="topBar">
                    <li id="acceuil">
                        ...
                        <a href="./referencer_nouvelle_recette.php">Référencer une nouvelle recette</a>
                    </li>
                </ul>
            </nav>
        </header>
        <main>
            <section>
                ...
                <form action="rechercher.php" method='get'>
                    <textarea id="searchBar" name="searchBar" placeholder="Entrez votre recherche..."></textarea>
